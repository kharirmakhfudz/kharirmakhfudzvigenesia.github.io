        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                          ...
                          new MaterialPageRoute(
                            builder: (BuildContext context) => new Login(key: null,),
                          ));
                    },
                  ),
                ], // penutup children
              ...
              TextButton(child: Icon(Icons.refresh), onPressed: () {_getData();},),
             ...
             FutureBuilder(
               ...
               FutureBuilder(
                ...
                AsyncSnapshot<List<MotivasiModel>> snapshot ) {
                  ...
                  return Column(
                    ...
                    child: ListView(
                     ...
                     children: [
                         ...
                         children: [ Expanded(child: Text(item.isiMotivasi)),
                          Row( children: [
                            TextButton(
                          ...
                          TextButton(child: Icon(Icons.delete),
                          onPressed: () {
                          deletePost(item.id)
                          .then((value) => {
                            ((value) => { 
                 ...
                 } else if(snapshot.hasError){return Text("${snapshot.hasError}");}
                 else{
                   return Text("No Data");
                 }
                }):Container(),
